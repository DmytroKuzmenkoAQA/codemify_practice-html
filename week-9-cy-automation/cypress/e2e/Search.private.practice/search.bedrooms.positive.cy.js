...
describe("Search bedrooms", () => {
  ...
  it("Search 4+ Bedrooms", () => {
    ...
    PrivateSearchPage.bedroomsDropDown.click();
    PrivateSearchPage.bedroomOption4.click();
    PrivateSearchPage.startSearchButton.click();

    PrivateSearchPage.collectAllBedroomsOnThePage(bedrooms);
    ...
    PrivateSearchPage.moveToNextPage()
    PrivateSearchPage.collectAllBedroomsOnThePage(bedrooms)
  ...
  //   PrivateSearchPage.datesCollect();
  //   PrivateSearchPage.clickNextPage.then(($btn) => {
  //     cy.wrap($btn)
